...
def main():
    ...
    if user_input:
        ...
        import os
        #We are fetching the previously stored Pinecone environment variable key in "Load_Data_Store.py" file
        index=pull_from_pinecone(os.getenv("PINECONE_API_KEY"),"gcp-starter","dataconnections",embeddings)
